...
test_that("PCC.Stemma works properly when no group can be built", {
  ...
  results = structure(
    list(edgelist = structure(c("E", "F", "1"), .Dim = c(1L,3L)), 
         database = 
           structure(c(1, 1, 1, 0, 1, 2, 1, 1, 1, 2, 2, 2, 2, 1, 1, 1, 2, 1, 1, 2), 
            .Dim = 4:5, .Dimnames = list(c("VL1", "VL2", "VL3", "VL4"), c("A", "B", "C", "D", "E"))), 
         modelsGlobal = list(list(structure(c(2, 1, 1, 2), .Dim = c(4L, 1L), .Dimnames = list(c("VL1", "VL2", "VL3", "VL4"), "{EF}")))), 
         modelsByGroupGlobal = list(structure("E", .Dim = c(1L, 1L), .Dimnames = list("Models", "EF")))))
